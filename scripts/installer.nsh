...
!macro customInstall
  ...
  nsExec::ExecToLog '"$SYSDIR\icacls.exe" "$0\InverterDashboard" /grant *S-1-5-32-545:(OI)(CI)M /T /Q'
  Pop $1
  StrCmp $1 "0" aclReady 0
  DetailPrint "WARNING: Could not grant Users modify access to the ADSI data directory (icacls exit $1)"
  aclReady:
