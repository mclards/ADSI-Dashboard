...
PORTABLE_ROOT = str(os.getenv("ADSI_PORTABLE_DATA_DIR") or "").strip()
...
if PORTABLE_ROOT:
    ...
    PROGRAMDATA_DIR = Path(PROGRAMDATA_ROOT) / "ADSI-InverterDashboard"
...
if EXPLICIT_DATA_DIR:
    ...
    if APPDATA_ROOT:
        DATA_DIR = Path(APPDATA_ROOT) / "ADSI-Dashboard"
    else:
        DATA_DIR = Path.home() / ".adsi-dashboard"
